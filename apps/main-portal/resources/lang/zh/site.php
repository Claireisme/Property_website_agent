...
return array_replace_recursive($base, [
    ...
    'nav' => ['properties' => '房源', 'valuation' => '估价', 'mortgages' => '贷款', 'contact' => '联系', 'admin' => '后台'],
    ...
    'messages' => ['enquiry_sent' => '您的咨询已发送。', 'offer_sent' => '您的报价已提交给中介审核。', 'contact_sent' => '谢谢，我们会尽快联系您。', 'valuation_sent' => '您的估价申请已发送。'],
]);
